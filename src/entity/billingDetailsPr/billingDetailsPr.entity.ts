...
import { CheckoutPr } from '../checkoutPr/CheckoutPr.entity';

@Entity('billing_details_pr')
export class BillingDetailsPr extends BaseModel {
    ...
    @OneToOne(() => CheckoutPr)
    @JoinColumn({ name: 'checkout_pr_id' })
