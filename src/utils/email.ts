...
/** Client portal login – OTP email. Same branding as proposal link (Ampli5 header, colors, layout). */
...
<body style="margin:0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background:#f5f5f5;">
  <div style="max-width:520px; margin:0 auto; background:#fff;">
    <div style="background:#956afa; padding:24px 20px; text-align:center;">
      <span style="font-size:24px; font-weight:bold; color:#fff;">Ampli5</span>
      <p style="margin:8px 0 0; font-size:14px; color:rgba(255,255,255,0.9);">Client Portal – Sign in to your account</p>
    </div>
    <div style="padding:32px 24px;">
      <h1 style="margin:0 0 16px; font-size:24px; font-weight:bold; color:#111;">Your login code</h1>
      <p style="margin:0 0 24px; font-size:16px; color:#333; line-height:1.5;">Enter this code on the website to sign in. It’s valid for <strong>${expiresInMinutes} minutes</strong>.</p>
      <div style="background:#f3f4f6; border-radius:8px; padding:20px 24px; margin:0 0 24px; text-align:center;">
        <span style="font-size:28px; font-weight:bold; color:#111; letter-spacing:4px;">${code}</span>
      </div>
      <p style="margin:0 0 24px; font-size:14px; color:#6b7280;">If you didn’t request this code, you can safely ignore this email. Your account is secure.</p>
      <hr style="border:none; border-top:1px solid #e5e7eb; margin:24px 0 16px;">
      <p style="margin:0; font-size:12px; color:#9ca3af;">Ampli5 Client Portal · This is an automated message. Please do not reply.</p>
    </div>
  </div>
</body>
</html>`;
